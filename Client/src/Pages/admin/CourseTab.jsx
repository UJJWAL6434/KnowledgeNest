...
const CourseTab = () => {
    ...
    const getCourseById = async () => {
        try {
            const res = await axios.get(`https://knowledgenest-q9le.onrender.com/api/v1/course/${id}`, {withCredentials:true})
            if(res.data.success){{
    ...
    const updateCourseHandler = async () => {
        ...
        try {
            setLoading(true)
            const res = await axios.put(`https://knowledgenest-q9le.onrender.com/api/v1/course/${id}`, formData, {
                headers: {
    ...
    const togglePublishUnpublish = async(action) => {
        try {
            const res = await axios.patch(`https://knowledgenest-q9le.onrender.com/api/v1/course/${id}`, {
                params: {
                    action
                },
                withCredentials:true
